...
import com.addzero.common.consts.SpringVars.sql
...
//
//
////    val usersPage =sql .createQuery(SysArea::class) {
////        select(table)
////    }.fetchPage(0, 100)
////    val users = usersPage.rows
//
//    // 计算当前页数据
...
//            //是否启用这个字段采用自定义渲染
//            Switch(
//                checked = user.enabled, onCheckedChange = { newValue ->
